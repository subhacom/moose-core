...
const Cinfo* HHGate2D::initCinfo()
{
    ...
    static ElementValueFinfo<HHGate2D, double> xmin(
        "xmin", "Minimum range for lookup", &HHGate2D::setXmin,
        &HHGate2D::getXmin);

    static ElementValueFinfo<HHGate2D, double> xmax(
        "xmax", "Minimum range for lookup", &HHGate2D::setXmax,
        &HHGate2D::getXmax);

    static ElementValueFinfo<HHGate2D, unsigned int> xdivs(
        "xdivs", "Divisions for lookup. Zero means to use linear interpolation",
        &HHGate2D::setXdivs, &HHGate2D::getXdivs);

    static ElementValueFinfo<HHGate2D, double> ymin(
        "ymin", "Minimum range for lookup", &HHGate2D::setYmin,
        &HHGate2D::getYmin);

    static ElementValueFinfo<HHGate2D, double> ymax(
        "ymax", "Minimum range for lookup", &HHGate2D::setYmax,
        &HHGate2D::getYmax);

    static ElementValueFinfo<HHGate2D, unsigned int> ydivs(
        "ydivs", "Divisions for lookup. Zero means to use linear interpolation",
...
///////////////////////////////////////////////////
HHGate2D::HHGate2D() : originalChanId_(0), originalGateId_(0)
{
    ;
}
